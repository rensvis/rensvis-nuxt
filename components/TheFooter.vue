...
<template>
  ...
  <section
    ...
    <div class="flex flex-col items-center justify-center mx-auto text-lg md:flex-row">
      ...
      <a href="tel:+31640999003" target="_blank" class="flex items-center mx-8 my-2 md:my-0">
        <ClientOnly>
      ...
      <a href="mailto:rens@rensvis.nl" target="_blank" class="flex items-center mx-8 my-2 md:my-0">
        <ClientOnly>
      ...
      <a href="https://www.linkedin.com/in/rens-vis-9218a9174/" target="_blank"
        class="flex items-center mx-8 my-2 md:my-0">
        <ClientOnly>
  ...
  <footer
    ...
    <div class="">
      ...
      <nav class="hidden sm:block">
        <ul class="flex">
          <li class="mx-3 md:mx-5">
            <NuxtLink to="/">Home</NuxtLink>
          </li>
          <li class="mx-3 md:mx-5">
            <NuxtLink to="/work">Work</NuxtLink>
          </li>
          <li class="ml-3 md:ml-5">
